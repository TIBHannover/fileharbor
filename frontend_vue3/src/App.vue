...
<template>
  <v-app :theme="theme">
    ...
    <v-navigation-drawer permanent rail>
      <v-list density="compact" nav v-model:selected="nav">
        <v-list-item prepend-icon="mdi-tune-variant" value="tune"></v-list-item>
        <v-list-item prepend-icon="mdi-filter" value="filter"></v-list-item>
        <v-list-item prepend-icon="mdi-view-dashboard-edit" value="view"></v-list-item>
        <v-list-item prepend-icon="mdi-forum" value="chat"></v-list-item>
        <v-list-item prepend-icon="mdi-graph" value="graph"></v-list-item>
        <v-list-item prepend-icon="mdi-export" value="export"></v-list-item>
      </v-list>
    </v-navigation-drawer>
    ...
    <v-navigation-drawer v-model="graphDrawer"> </v-navigation-drawer>
    <v-navigation-drawer v-model="exportDrawer"> </v-navigation-drawer>
