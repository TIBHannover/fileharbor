    ...
    def call(self, entries):
        ...
        for entry in entries:
            ...
            result = self.con.modelrun(
                self.model_name,
                f"image_{job_id}",
                [f"probabilities_head1_{job_id}", f"probabilities_head2_{job_id}"],
            )
            ...
            for x in result_list:
                ...
                concepts.append(
                    analyser_pb2.Concept(concept=name, type="style", prob=prob)
                )
            ...
            for x in result_list:
                ...
                concepts.append(
                    analyser_pb2.Concept(concept=name, type="genre", prob=prob)
                )
